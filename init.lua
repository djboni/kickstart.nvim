...
vim.keymap.set('n', '<C-j>', '080lBXi<Return><Esc>080l', { desc = 'Break line at column 80' })
vim.keymap.set('i', '<C-j>', '<Esc>080lBXi<Return><Esc>079la', { desc = 'Break line at column 80' })
