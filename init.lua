...
vim.keymap.set('n', '<C-k>', '080lBXi<Return><Esc>080l', { desc = 'Break line at column 80' })
vim.keymap.set('i', '<C-k>', '<Esc>080lBXi<Return><Esc>079la', { desc = 'Break line at column 80' })
